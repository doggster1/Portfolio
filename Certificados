...
- Ativos, Ameaças e Vulnerabilidades / Assets, Threats, and Vulnerabilities – Google (Coursera)

- Soar o Alarme: Detecção e Resposta / Sound the Alarm: Detection and Response – Google (Coursera)

- Automatizar Tarefas de Cibersegurança com Python / Automate Cybersecurity Tasks with Python – Google (Coursera)

- Coloque em Prática: Prepare-se para Trabalhos em Cibersegurança / Put It to Work: Prepare for Cybersecurity Jobs – Google (Coursera)
